...
var file_proto_my_service_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x22, 0x14, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x43, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c,
	...
	0x0a, 0x09, 0x4d, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x59, 0x0a, 0x04, 0x45,
	0x63, 0x68, 0x6f, 0x12, 0x22, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x5f, 0x31, 0x30, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x22, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x5f, 0x31, 0x30, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x09, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x03, 0x12, 0x01, 0x2f, 0x12, 0x76, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
...
var file_proto_my_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_my_service_proto_goTypes = []interface{}{
	(*StringMessage)(nil),       // 0: grpc_gateway_101.v1.StringMessage
	(*HealthCheckRequest)(nil),  // 1: grpc_gateway_101.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil), // 2: grpc_gateway_101.v1.HealthCheckResponse
}
var file_proto_my_service_proto_depIdxs = []int32{
	...
	1, // 1: grpc_gateway_101.v1.MyService.HealthCheck:input_type -> grpc_gateway_101.v1.HealthCheckRequest
	0, // 2: grpc_gateway_101.v1.MyService.Echo:output_type -> grpc_gateway_101.v1.StringMessage
	2, // 3: grpc_gateway_101.v1.MyService.HealthCheck:output_type -> grpc_gateway_101.v1.HealthCheckResponse
...
func file_proto_my_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_my_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_my_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
